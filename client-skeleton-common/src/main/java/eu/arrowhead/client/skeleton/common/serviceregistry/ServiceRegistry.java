...
import eu.arrowhead.client.skeleton.common.misc.Miscellaneous;
import eu.arrowhead.client.skeleton.common.serviceregistry.standalone.SystemDefinition;
...
public class ServiceRegistry {
    ...
    @Autowired
    private SystemDefinition systemDefinitions;
    ...
    /**
     * Registers systems/services which are specified in application.properties
     * @throws MalformedParametersException
     */
    public void registerExternalServices() throws MalformedParametersException {
        if (systemDefinitions.getSystems() == null)
            throw new MalformedParametersException("No systems defined in application.properties");
                    ...
                    system
                            ...
                            .forEach(service -> {
                                this.registerExternalService(
                                        system.getKey(),
                                        system.getValue().getAddress(),
                                        system.getValue().getPort(),
                                        system.getValue().isTokensecurityfilterEnabled(),
                                        system.getValue().isSslenabled(),
                                        service.getValue().getInterfaceInsecure(),
                                        service.getValue().getInterfaceSecure(),
                                        service.getKey(),
                                        service.getValue().getServiceUri(),
                                        service.getValue().getVersion(),
                                        service.getValue().getHttpMethod(),
                                        service.getValue().getMetadata()
                                );
                            });
                });
    }
    ...
    public void registerExternalService(
        ...
        serviceRegistryRequest.setVersion(version);
    ...
    /**
     * unregisters services from application.properties
     */
    public void unregister() {
        systemDefinitions
                ...
                .parallelStream()
                .parallel()
                .flatMap(o -> o.getServices().keySet().stream())
                .forEach(o -> this.unregister(o));
    }
